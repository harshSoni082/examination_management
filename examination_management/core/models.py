...
class State(models.Model):
    ...
    country = models.ForeignKey(
        Country, on_delete=models.CASCADE, blank=True, null=True, related_name='country_state')
...
class City(models.Model):
    ...
    state = models.ForeignKey(
        State, on_delete=models.CASCADE, blank=True, null=True, related_name='state_city')
...
class Address(StatusMixin, AddressMixin, TimeStampedModel):
    ...
    latitude = models.CharField(
        _('Latitude'), max_length=40, blank=True, null=True)
    longitude = models.CharField(
        _('Longitude'), max_length=40, blank=True, null=True)
